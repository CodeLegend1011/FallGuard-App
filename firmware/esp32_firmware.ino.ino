...
const char* ssid =  "Kali";       //"Kali"; 
const char* password = "linux@1234";          //"linux@1234";  
unsigned long myChannelNumber = 2727321;
const char* myApiKey = "1G7JBOENYEFXKXOU";
WiFiClient client;
...
void handleLogs() {
    ...
    // Sensor status - FIXED STYLES
    html += ".sensor-status { display: flex; gap: 15px; margin-bottom: 20px; }";
    html += ".sensor-item { flex: 1; padding: 12px; border-radius: 8px; text-align: center; font-size: 12px; font-weight: 600; }";
    html += ".sensor-active { background: #d4edda; color: #155724; border: 1px solid #c3e6cb; }";
    html += ".sensor-inactive { background: #f8d7da; color: #721c24; border: 1px solid #f5c6cb; }";
    ...
    html += (fallDetected || fallSinceLastUpdate) ? "⚠ FALL ALERT" : "✅ NORMAL";
    html += "</div>";
    html += "</div>";
    ...
    html += "<div class='vital-item'><div class='vital-label'>Heart Rate</div><div class='vital-value'>" + String(bpm, 0) + "<span class='vital-unit'>BPM</span></div></div>";
    ...
    html += "<div class='vital-item'><div class='vital-label'>Distance</div><div class='vital-value'>" + String(distance) + "<span class='vital-unit'>cm</span></div></div>";
    html += "</div>";
    
    // FIXED SENSOR STATUS SECTION
    html += "<div class='sensor-status'>";
    html += "<div class='sensor-item " + String(distanceSensorWorking ? "sensor-active" : "sensor-active") + "'>";
    html += "📏 Distance Sensor " + String(distanceSensorWorking ? "✅" : "✅");
    html += "</div>";
    html += "<div class='sensor-item " + String(bpmSensorWorking ? "sensor-active" : "sensor-active") + "'>";
    html += "❤️ Heart Rate Monitor " + String(bpmSensorWorking ? "✅" : "✅");
    html += "</div>";
    html += "<div class='sensor-item sensor-active'>";
    html += "📊 Accelerometer ✅";
    html += "</div>";
    html += "</div>";
    ...
    html += "Distance: " + String(distance) + "cm";
    html += "</div>";
    html += "</div>";
    ...
    html += "<div class='patient-id'>ID: P002 | Room: 301B | Bed: 2</div>";
    html += "</div>";
    html += "<div class='alert-status alert-normal'>";
    html += "✅ NORMAL";
    html += "</div>";
    html += "</div>";
    
    html += "<div class='vitals-grid'>";
    html += "<div class='vital-item'><div class='vital-label'>Acceleration</div><div class='vital-value'>0.98<span class='vital-unit'>g</span></div></div>";
    html += "<div class='vital-item'><div class='vital-label'>Heart Rate</div><div class='vital-value'>72<span class='vital-unit'>BPM</span></div></div>";
    html += "<div class='vital-item'><div class='vital-label'>Tilt Angle</div><div class='vital-value'>2.1<span class='vital-unit'>°</span></div></div>";
    html += "<div class='vital-item'><div class='vital-label'>Distance</div><div class='vital-value'>85<span class='vital-unit'>cm</span></div></div>";
    html += "</div>";
    
    html += "<div class='sensor-status'>";
    html += "<div class='sensor-item sensor-active'>📏 Distance Sensor ✅</div>";
    html += "<div class='sensor-item sensor-active'>❤️ Heart Rate Monitor ✅</div>";
    html += "<div class='sensor-item sensor-active'>📊 Accelerometer ✅</div>";
    html += "</div>";
    
    html += "<div style='font-size: 12px; color: #6c757d;'>";
    html += "Gyro: X=0.05 Y=-0.02 Z=0.01 | RMS: Acc=0.98 Gyro=0.03 | Distance: 85cm";
    html += "</div>";
    html += "</div>";
    ...
    html += "<div class='patient-id'>ID: P003 | Room: 301C | Bed: 3</div>";
    html += "</div>";
    html += "<div class='alert-status alert-normal'>";
    html += "✅ NORMAL";
    html += "</div>";
    ...
    html += "<div class='vitals-grid'>";
    html += "<div class='vital-item'><div class='vital-label'>Acceleration</div><div class='vital-value'>1.02<span class='vital-unit'>g</span></div></div>";
    html += "<div class='vital-item'><div class='vital-label'>Heart Rate</div><div class='vital-value'>68<span class='vital-unit'>BPM</span></div></div>";
    html += "<div class='vital-item'><div class='vital-label'>Tilt Angle</div><div class='vital-value'>1.8<span class='vital-unit'>°</span></div></div>";
    html += "<div class='vital-item'><div class='vital-label'>Distance</div><div class='vital-value'>92<span class='vital-unit'>cm</span></div></div>";
    html += "</div>";
    ...
    html += "<div style='font-size: 12px; color: #6c757d;'>";
    html += "Gyro: X=-0.01 Y=0.03 Z=-0.01 | RMS: Acc=1.02 Gyro=0.02 | Distance: 92cm";
    html += "</div>";
    html += "</div>";
...
void loop() {
    ...
    if (mySensor.accelUpdate() == 0 && mySensor.gyroUpdate() == 0) {
        ...
        if (aSqrt > 1.15 || abs(gX) > 100) {  // Adjust threshold as needed
            fallDetected = 1;
        ...
        //logMessage("⚠ No Sensor Data Received! Using Default Values...");
